...
def run_chat(messages: list) -> str:
    ...
    for round_num in range(max_rounds):
        ...
        if not tool_calls:
            # Caught an unfinished "let me check" reply with rounds left -- force it to actually
            # call a tool and finish the job instead of returning the filler to the user.
